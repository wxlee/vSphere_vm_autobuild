...
echo_msg "[INFO] Create runin_chroot.sh"
...
chk_status
echo_msg "[INFO] Upload iso to NAS"
...
if [ -d live_boot  ];then
    rm -r live_boot
    echo_msg "[INFO] Workspace found, remove it."
fi
